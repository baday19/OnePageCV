              ...
              if (line.className === 'line-two-sides') {
                return (
                  <div className="line-two-sides">
                    <div className="bold-text">{line.value[0].value}</div>
                    <div className="normal-text">{line.value[1].value}</div>
                  </div>
                )
    ...
    <div id="resume0">
      ...
      <div className="main">
        ...
        <div className="common-info">
          ...
          <div className="line-two-sides">
            <div className="bold-text">浙江大学</div>
            <div className="normal-text">2023年09月 - 2026年04月</div>
          </div>
          <div className="line-normal">软件工程 硕士</div>
          <div className="line-normal">GPA：92.5 / 100</div>
          <div className="line-normal">相关课程：面向对象系统分析和设计、智能移动应用开发技术、智能化软件质量保证、软件测试技术、数据可视化技术</div>
          <div className="line-two-sides">
            <div className="bold-text">西北工业大学</div>
            <div className="normal-text">2019年09月 - 2023年06月</div>
          </div>
          <div className="line-normal">软件工程 本科</div>
          <div className="line-normal">GPA：3.58 / 4.10（专业前10%）</div>
          <div className="line-normal">荣誉奖项：科为奖学金（年级仅2位）、一等奖学金、全国大学生软件测试大赛全国二等奖、中国大学生计算机设计大赛省级一等奖</div>
        </div>
        {/* 实习经历 */}
        <div className="common-info">
          <div className="common-title">
